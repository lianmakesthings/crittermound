...
url=`curl -H "Authorization: Bearer $NETLIFY_AUTH_TOKEN" https://api.netlify.com/api/v1/sites/crittermound/deploys`
...
curl -X POST -H "Authorization: Bearer $NETLIFY_AUTH_TOKEN" -d "{}" "https://api.netlify.com/api/v1/sites/crittermound/deploys/${temp##*|}/restore"
